...
#include "acs_compat/ACS_Hexen/AsmFunc_Compat.h"
...
ACS_AsmFuncDeclFull(143, , 0, void,   GiveInventory, __str, int);
ACS_AsmFuncDeclFull(145, , 0, void,   TakeInventory, __str, int);
ACS_AsmFuncDeclFull(147, , 0, int,    CheckInventory, __str);
ACS_AsmFuncDeclFull(149, , 2, int,    Spawn, __str, _Accum, _Accum, _Accum, int, int);
ACS_AsmFuncDeclFull(151, , 2, int,    SpawnSpot, __str, int, int, int);
ACS_AsmFuncDeclFull(153, , 2, void,   SetMusic, __str, int, int);
ACS_AsmFuncDeclFull(155, , 2, void,   LocalSetMusic, __str, int, int);
...
ACS_AsmFuncDeclFull(165, , 0, void,   SetFont, __str);
